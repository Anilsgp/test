...
namespace MYSampleApp.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,DOB,Phone,Email")] CustomerModel customerModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,DOB,Phone,Email")] CustomerModel customerModel)
        {
